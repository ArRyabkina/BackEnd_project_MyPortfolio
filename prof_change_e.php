...
<body>
    ...
    <div class="main">
        ...
        <div class="col-10 mx-auto s mt-4 bg-light border p-3">
			...
			<form <?php echo 'action="prof_change_func_e.php?id=' . $_GET['id'] . '"'; ?> method="POST" enctype="multipart/form-data">
				  	...
				  	<?php 
                        ...
                        for($i=0;$i<$query_olymp->num_rows; $i++){
                            ...
                            if($res_cl['class_name']==$res_u['u_class']){
                                echo '<option selected value="' . $res_cl['id_class'] . '">' . $res_cl['class_name'] . '</option>';
                            }else {
                                echo '<option  value="' . $res_cl['id_class'] . '">' . $res_cl['class_name'] . '</option>';
                            }
                        }
                         ?>
				  </select>
